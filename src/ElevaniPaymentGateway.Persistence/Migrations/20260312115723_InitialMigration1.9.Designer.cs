...
namespace ElevaniPaymentGateway.Persistence.Migrations
{
    ...
    [Migration("20260312115723_InitialMigration1.9")]
            ...
            modelBuilder.Entity("ElevaniPaymentGateway.Core.Entities.AuditTrail", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2026, 3, 12, 12, 57, 22, 881, DateTimeKind.Local).AddTicks(1792));
            ...
            modelBuilder.Entity("ElevaniPaymentGateway.Core.Entities.Merchant", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 3, 12, 12, 57, 22, 920, DateTimeKind.Local).AddTicks(8544));
            ...
            modelBuilder.Entity("ElevaniPaymentGateway.Core.Entities.OTP", b =>
                {
                    ...
                    b.Property<DateTime>("DateGenerated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 3, 12, 12, 57, 22, 934, DateTimeKind.Local).AddTicks(5601));
            ...
            modelBuilder.Entity("ElevaniPaymentGateway.Core.Entities.Transaction", b =>
                {
                    ...
                    b.Property<string>("MerchantIPAddress")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("ElevaniPaymentGateway.Core.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2026, 3, 12, 12, 57, 22, 938, DateTimeKind.Local).AddTicks(2126));
